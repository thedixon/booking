...
<head>
    ...
    <script src='js/basket_admin.js'></script>
                    ...
                    <li>
                        <form class="form-horizontal" style="padding-top: 5px">
                            <div class="form-group">
                                <label class="col-md-6 control-label">Search for customer</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" data-bind="value: customerId" />
                                </div>
                            </div>
                        </form>
                    </li>
